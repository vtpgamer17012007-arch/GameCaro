...
void startGame(bool isNewGame,  bool isbot, int XX, int YY, string name1, string name2, vector<pair<int, int>> Data, string fileName, int Xscore, int Oscore, int winStreak);
